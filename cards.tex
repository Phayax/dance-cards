...
\dancedifficultmarker
\begin{center}
\includegraphics[width=0.45\textwidth]{img/Gingerbread}
\end{center}
...
\dancename{The Aviator}
\iffalse\subsection{The Aviator}\fi % fool texstudio into displaying subsections
%\danceinfo{3C/4C longwise set, 8x32 J}
\begin{center}
	\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{external-img/aviator}}%
...
\dancename{The Riders of Rohan}
\iffalse\subsection{The Riders of Rohan}\fi % fool texstudio into displaying subsections
%\danceinfo{3C/4C longwise set, 8x32 J}
\begin{center}
	\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{external-img/rohan}}%
	%	\includegraphics[width=1.1\textwidth]{external-img/aviator}
\end{center}
\newpage
\danceinstructionsbegin
\danceinstructionsel
\danceinstructionsel
1 -- 8 & 1s dance Inveran reels with 2s+3s. 2s end facing out\\
9 -- 16 & Reels of 3 across: 1M+2s \& 1L+3s. To start 1s cross down, 2s dance up sides, 3s pass RSh then 1M passes 2L LSh, 1L passes 3L LSh. 1s end passing RSh to face 1st corners\\
17 -- 24 & 1s dance diag reel of 4 with 1st corners \& pass RSh to face 2nd corners\\
25 -- 32 & 1s dance diag reel of 4 with 2nd corners \& pass RSh to face 2nd corners again\\
33 -- 40 & 1s dance 6 bar reels of 3 on opposite sides (RSh to 2nd corners) \& 1s cross RH to 2nd place own sides
\dancemediummarker
\danceinstructionsend
...
\dancename{Firecracker Reel}
\iffalse\subsection{Firecracker Reel}\fi % fool texstudio into displaying subsections
%\danceinfo{3C/4C longwise set, 8x32 J}
\begin{center}
	\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{external-img/firecracker}}%
	%	\includegraphics[width=1.1\textwidth]{external-img/aviator}
\end{center}
\dancemediummarker
...
\dancename{Le Béret Rose}
\iffalse\subsection{Le Béret Rose}\fi % fool texstudio into displaying subsections
%\danceinfo{3C/4C longwise set, 8x32 J}
\begin{center}
	\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{external-img/beretrose}}%
	%	\includegraphics[width=1.1\textwidth]{external-img/aviator}
\end{center}
\dancemediummarker
...
\dancename{The Half Crown Jig}
\iffalse\subsection{The Half Crown Jig}\fi % fool texstudio into displaying subsections
%\danceinfo{3C/4C longwise set, 8x32 J}
\begin{center}
	\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{external-img/halfcrown}}%
	%	\includegraphics[width=1.1\textwidth]{external-img/aviator}
\end{center}
\dancemediummarker
