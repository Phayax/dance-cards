...
\setmainfont{Coelacanth}[
	...
	%Ligatures=TeX
	% Lining Numbers to get full and even height numbers
	Numbers=Lining  % use Numbers={Lining,Monospaced} if that is necessary
	]
...
\iffalse\subsection{Act with Agility}\fi % fool texstudio into displaying subsections

\dancename{Act with Agility}
\origininfo{Brooke Friendly \& Chris Sackett}{Play with Alacrity}{Dave Bartley}
\danceinfo{Duple Minor}
\danceinstructionsbegin
1 -- 8 & Linkhandstern\\
9 -- 16 & Nachbarn linke Handtour\\
1 -- 12 & 3-Hände Kette (rechts mit Partner beginnend)\\
13 -- 16 & P1 passiert sich rechtsschultrig, und bleibt in der Mitte Rücken an Rücken stehen\\
\danceinstructionsel
& \textbf{Double Triangles}\\
1 -- 4 & Alle: Set rechts (in Linien durchgefasst)\\
5 -- 8 & P2: Set rechts, P1 wechselt die Seiten. Geht im UZS halb herum, wieder Rücken and Rücken\\
9 -- 12 & Alle: Set rechts (in Linien durchgefasst)\\
13--16 & P2: Set rechts, P1 wie vorher, aber landet auf der Seitenlinie (rechte Schulter zurückziehen)\\
\danceinstructionsel
1 -- 8 & Paare Dos-a-dos\\
9 -- 16 & Rechthandstern\\
\dancemediummarker
\danceinstructionsend
\noindent\textit{Die Bäumchen können die Double Triangles mitmachen.\\P1 ist abwechselnd proper \& improper}
...
\iffalse\subsection{Algorhythms}\fi % fool texstudio into displaying subsections

\dancename{Algorhythms}
\origininfo{Orly Krasner}{Frank Palmer}{Turlough O'Carolan}
\danceinfo{Longways for four Couples\\1er \& 2er improper}
\danceinstructionsbegin
1 -- 8 & Endpaare long Cast in Mitte, Mittelpaare Meet \& Lead Out\\
9 -- 12 & Jetzt Mittlere Paare mit Partner nähere Hand fassen und umklappen (H rückwärts, D vorwärts)\\
13--16 & Halber Setkreis Mitte\\
1 -- 16 & Von neuen Positionen wiederholen\\
\danceinstructionsel
1 -- 8 & Herren gehen rechtschultrig um Partnerin(die stehen bleibt), dann zurück auf eigenen Platz mit Blick in UZS\\
9 -- 16 & Herren halbes Chase around the Set (skip change), um auf diagonal gespiegelter Position zu enden\\
17--20 & Oben und unten Rechthandstern (schnell!)\\
21--24 & Mittlere Positionen Linkhandstern (schnell!)\\
\danceinstructionsel
1 -- 16 & Damen wiederholen: Linkschultrig um Gegenüber, zurück auf Platz, halbes Chase around the Set GUZS\\
17--24 & Paare linke Handtour
...
\origininfo{Pat Shaw (1974)}{The Amazed Geneticist}{Pat Shaw}
\iffalse\subsection{The Amazed Geneticist}\fi % fool texstudio into displaying subsections
\danceinfo{Four Couples Longways, P3 \& 4 improper}
\danceinstructionsbegin
1 -- 16 & P1 mit P2 \& P3 mit P4 Double Figure Eights (Äußere kreuzen, Innere casten)\\
1 -- 16 & Double Figure Eights auf den Seiten: Äußere als erstes kreuzen, Innere als erstes casten (ist nicht mit dem Partner zusammen, der Cast und das Kreuzen sind nach außen, von der anderen Linie weg.)\\
\danceinstructionsel
1 -- 4 & P1 \& P4 Lead in die Mitte, P2 \& P3 gehen aus der letzten Figure kommend auf die äußeren Plätze\\
5 -- 8 & Mittle Paare: Damen linksschultriger Platzwechsel, Herren rechtsschultrig\\
9 -- 16 & In den zwei Duple Minor Sets: Setkreis\\
\danceinstructionsel
1 -- 8 & Äußere Paare gaten die inneren Paare in einen großen Kreis (alle durchfassen)\\
9 -- 16 & \nicefrac{1}{2} \& Großer Setkreis nach links
\dancedifficultmarker
\danceinstructionsend

\noindent
\textit{Für Bonus Spaß den letzten Setkreis \nicefrac{3}{4} herum tanzen.}\\


\noindent
\textit{Aus der Originalanleitung: Im A-Teil (Double-8s) Skip step tanzen, die Setkreise mit Slip step, der Rest normal gelaufen.}
...
\iffalse\subsection{An Enchanted Place}\fi % fool texstudio into displaying subsections

\dancename{An Enchanted Place}
\origininfo{Antony Heywood}{Hewlett}{O' Carolan}
\danceinfo{Square, \nicefrac{3}{4}}
\danceinstructionsbegin
\textbf{Takte} & \\
1 -- 4 & P1 \nicefrac{1}{2} Orbit GUZS um das Set, währenddessen andere Paare \nicefrac{1}{2} Setkreis UZS\\
5 -- 8 & P1 kommt zu den anderen Paaren in den Kreis und alle \nicefrac{1}{2} Setkreis GUZS\\
1 -- 4 & Nachbarn (nicht-Partner) linke Handtour\\
5 -- 8 & Paare rechte Handtour\\
\danceinstructionsend
\begin{longtable}{p{1cm} p{4.9cm} | p{4.9cm}}
1 -- 2 & P1 Lead in Mitte, dann zueinander wenden & -- \\
3 -- 4 & P1 Poohsette, P2 macht ein Tor und Lead in & -- \\
5 -- 6 & P2 Poohsette, P3 Lead in & P1 Eeyore\\
7 -- 8 & P3 Poohsette, P4 Lead in & P2 Eeyore\\
9 -- 10 & P4 Poohsette & P3 Eeyore, P1+P2 zueinander Step right \& honour\\
11--12 & ~ & P4 Eeyore, P1+P2+P3 zueinander Step left \& honour\\
13--16 & \multicolumn{2}{c}{Alle Ronde}
\dancedifficultmarker
\danceinstructionsend
\noindent\textbf{Poohsette:} Das Paar führt mit beiden Händen gefasst auf den nächsten äußeren Platz.

\noindent\textbf{Eeyore:} Herr lässt linke, Dame rechte Hand los, Dame Balance nach vorne, Herr umrundet die Dame im UZS bis sie wieder in Square Aufstellung stehen.
...
\danceinstructionsel
1 -- 16 & Paar 1 Figure Eight durch Paar 2\\
\danceinstructionsend
...
\iffalse\subsection{Barbarinis Tambourine}\fi % fool texstudio into displaying subsections
\dancename{Barbarinis Tambourine}
\origininfo{Walsh}{Barbarinis Tambourine}{Walsh}
\danceinfo{Duple Minor}
\danceinstructionsbegin
1 -- 16 & FC Cast um Nachbarn, dann in der Mitte passieren (auf anderer Seite) und um Partner auf Platz der anderen Corner\\
1 -- 16 & SC Wiederholung (gespiegelt)\\
\danceinstructionsel
1 -- 8 & Auf Seitenlinien Hände fassen: Fall back \& Partner passieren\\
9 -- 16 & Linie Dos-a-dos\\
17--24 & Paare Dos-a-dos (Hüpf!)\\
\danceinstructionsel
1 -- 16 & 4-Hände Kette mit Partner rechts beginnend\\
17--24 & Paare Ronde
\dancemediummarker
\danceinstructionsend
...
\iffalse\subsection{Bath Carnival}\fi % fool texstudio into displaying subsections
\dancename{Bath Carnival}
\origininfo{Thompson (1777)}{Keppel's Delight}{}
\danceinfo{Triple Minor}
\danceinstructionsbegin
1 -- 8 & P1 Lead durch Damen \& Cast in Mitte des Sets (D1 links, H1 rechts)\\
1 -- 16 & P1 Lead durch Herren \& Cast in Mitte des Sets (D1 rechts, H1 links), dann Lines of Three across(H1 + P3, D1 + P2)\\
1 -- 4 & Lines of Three, schauen hoch/runter: Set\\
5 -- 8 & P1 \nicefrac{3}{4} Ronde in mittlere Setposition, P1 \& P3 \nicefrac{1}{2} Ronde\\
9 -- 12 & Lines of Three, Paare zueinander: Set\\
13--16 & Alle \nicefrac{1}{2} Ronde\\
1 -- 16 & Setkreis nach links und zurück\\
1 -- 8 & Alle nach außen wenden, Lines of Three Lead Out, Turn, Lead back in\\
1 -- 8 & Set \& Turn Rechts
\dancemediummarker
\danceinstructionsend
...
\iffalse\subsection{Beach Spring}\fi % fool texstudio into displaying subsections
\dancename{Beach Spring}
\origininfo{Leslie Lassetter}{Come and Find the Quiet Center}{traditional/B.F. White}
\danceinfo{Longway for four Couples, \nicefrac{3}{4} Takt}
\danceinstructionsbegin
\textbf{Takte} & \\
1 -- 4 & Oben \& unten Setkreis nach links (UZS)\\
5 -- 8 & Serpentine: Oben und unten tauschen die Plätze: D2 + H3 passieren sich linksschultrig, der rest "ihres" Setkreises folgt ihnen (Unspooling UZS in Setkreis Laufrichtung), auf der anderen Seite des Sets "Respooling" GUZS in zwei Kreise (Alle landen auf gespiegelten Position im 4er Longway, aber auf gleicher Seite).\\
\danceinstructionsel
1 -- 2 & Pos 1 Cast Down, Pos 2 Lead Up\\
3 -- 4 & Pos 2 \& 3 Cast (jeweils 1 Pos.) Down, Pos 4 Lead Up (2 Pos)\\
5 -- 8 & Jeweils Oben \& Unten: 4-Hände Kette
\dancemediummarker
\danceinstructionsend
...
\iffalse\subsection{Cacao}\fi % fool texstudio into displaying subsections

\dancename{Cacao}
\origininfo{Brooke Friendly \& Chris Sackett}{Aptos}{Rachel Bell}
\danceinfo{Triple Minor longways}
\danceinstructionsbegin
1 -- 16 & $\sim$ \nicefrac{3}{4} Shetland Reel. Hey for three mit den Paaren als eine Einheit (D1, H2, D3 als Leads (Rest Follow)). P1 \& P3 rechtschultrig starten. Am Ende P3 noch Platzwechsel. Neue Positionen: P3, P1, P2 alle improper.\\
1 -- 8 & Oben P3 \& P1: Rechthandmühle\\
9 -- 16 & Unten P1 \& P2: Linkshandmühle\\
\danceinstructionsel
1 -- 8 & SCD-like: P1 passiert sich linkshändig, dann rechte Handtour mit 1st Corner\\
9 -- 16 & P1 linkshändig passieren, dann rechte Handtour mit 2nd Corner (1er proper, 2er \& 3er improper)\\
1 -- 8 & P1 Siding rechtsschultrig, während: P2 \& P3 Orbit halb ums Set: jeweils nach oben/unten schauen, dann "Nachbarn" auf Seitenlinie passieren + Partner über Gasse (immer rechtsschultrig)\\
9 -- 16 & Paare rechte Handtour \& für neues Shetland Reel orientieren
\dancedifficultmarker
\danceinstructionsend
...
\iffalse\subsection{Calgarth Hornpipe}\fi % fool texstudio into displaying subsections

\dancename{Calgarth Hornpipe}
\origininfo{Thomas Pietzka (CC-BY)}{Calgarth Hornpipe}{traditional}
\danceinfo{Sicilian Circle}
\danceinstructionsbegin
1 -- 4 & Set to Back rechts: Set rechts: mit rechtem Fuß neben Partner:in, mit linkem Fuß vorbei, sodass Partner:innen rechte Schulter an rechter Schulter stehen. \\
5 -- 8 & ca. \nicefrac{3}{4} Gypsy rechtsschultrig zurück auf Startpositionen\\
9 -- 16 & 3 - Hände Kette mit Partner:in rechtschultrig startend\\
1 -- 8 & Set to Back links \& \nicefrac{3}{4} Gypsy linkschultrig zurück\\
9 -- 16 & Mühle linkshändig, danach zu fremdem Set schauen\\
\danceinstructionsel
1 -- 4 & Entlang der Kreisbahn Circular Hey 2 Schultern weiter (mit rechts starten, auf Innen- und Außenbahn separat)\\
5 -- 8 & \nicefrac{1}{2} Setkreis mit entgegenkommendem Paar\\
9 -- 16 & Pousette-Hey zurück: In der Laufrichtung aus dem Setkreis kommend eine halbe Pousette im UZS in die Richtung aus der man kam, und dann noch eine halbe Pousette GUZS in der selben Richtung, dann entgegenkommendes Paar anschauen\\
1 -- 4 & Entlang der Kreisbahn Circular Hey 2 Schultern weiter (wieder mit rechts starten)\\
5 -- 8 & \nicefrac{1}{2} Setkreis mit entgegenkommendem Paar\\
9 -- 16 & Pousette-Hey zurück
\dancemediummarker
\danceinstructionsend
...
\iffalse\subsection{Companions}\fi % fool texstudio into displaying subsections

\dancename{Companions}
\origininfo{Victor Skowronski}{Ronde II}{Susato}
\danceinfo{Duple Minor}
\danceinstructionsbegin
1 -- 4 & Single file Circle eine Position (UZS)\\
5 -- 8 & Balance the Ring\\
1 -- 8 & Wiederholen\\
\danceinstructionsel
1 -- 8 & FC Chevron rechts: Rechtsschultrig passieren, nach außen schauen und rückwärts auf den Nachbarplatz. Auf 5 -- 8: SC Cast über rechte Schulter, geht über in ...\\
1 -- 8 & Paare \nicefrac{3}{4} Pousette (UZS) um in Line of Four zu landen, FC schauen sich an\\
1 -- 12 & Hey for Four, 6 Wechsel, FC starten linksschultrig\\
1 -- 6 & SC in der Mitte \nicefrac{3}{4} Gypsy linksschultrig, FC \nicefrac{1}{4} Orbit UZS \\
7 -- 12 & Paare rechtschultriger Gypsy 1\nicefrac{1}{4} nach Hause
\dancedifficultmarker
\danceinstructionsend
...
\danceinfo{Tanz für 9 Personen,\\ in 3x3 Quadrat aufgestellt\\(auch: Das Scheitern des Premierministers)}
\danceinstructionsbegin
1 -- 16 & Die mittlere und rechte Spalte gehen in Promenadenfassung um die linke Spalte herum\\
...
\danceinstructionsel
1 -- 16 & Die Reihen tanzen jeweils eine Hey, die Mitten starten nach links rechtsschultrig\\
\danceinstructionsel
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Double Greased Weasel
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage

\iffalse\subsection{Double Greased Weasel}\fi % fool texstudio into displaying subsections
\dancename{Double Greased Weasel}
\danceinfo{Longways for Four Couples, 1er + 3er improper}
\origininfo{Thomas Pietzka}{???}{???}
\danceinstructionsbegin
1 -- 8 & Alle Herren Cast, alle Damen folgen. Äußere Paare \textbf{2(!)} Positionen nach innen. Innere Paare nach außen, und umdrehen für...\\
9 -- 12 & Oben \& unten: \nicefrac{1}{2} Linkhandsterne\\
13--16 & Jetzt wieder äußere P1 \& P4: \nicefrac{1}{4} Chase around the Set GUZS, \\
& P2 \& P3: jeweils \nicefrac{3}{4} linke Handtour zu einer Linie in der Mitte des Sets und Partner anschauen\\
\danceinstructionsel
1 -- 16 & \textbf{Double Dolphin Weasel Reel}\\
\danceinstructionsel
1 -- 4 & P2 + P3 \nicefrac{3}{4} linke Handtour, P1 \& P4 \nicefrac{1}{4} Chase around ans Ende des Sets (GUZS)\\
5 -- 8 & Oben \& unten: \nicefrac{1}{2} Linkhandsterne\\
9 -- 12 & P2 \& P3 \nicefrac{1}{2} linke Handtour, \\
 & P1 \& P4 auf Seitenlinien rechtsschultrig passieren\\
13--16 & Alle Set rechts (zu Partner:in)\\
\danceinstructionsel
 & \textbf{Doppeltes „La Baratte“}\\
 1 -- 4 & Paare \nicefrac{1}{2} rechte Handtour\\
 5 -- 8 & Paare linke Hand unter rechter fassen \& Platzwechsel, Damen unter Arm drehen\\
 1 -- 4 & Paare \nicefrac{1}{2} linke Handtour\\
 5 -- 8 & Paare rechte Hand unter linker fassen \& Platzwechsel, Herren unter Arm drehen\\
\danceinstructionsend

\clearpage
\begin{center}\large \textbf{Double Dolphin Weasel Reel:}\end{center}
Ein linksschultriges Weasel Reel aus dem Scottish, wobei die außen startenden Paare gedoppelt als Tandem/Delfine tanzen.\\[.1cm]
\noindent\textbf{Grundsätzliches}: \\
Innerer Laufweg: linksschultrige \nicefrac{1}{2} Hey\\
Äußerer Laufweg: \nicefrac{1}{2} Chase around the Set (mit Lead change an Enden)\\
Alle laufen einen ganzen (wobbly) Kreis GUZS in ihrer „Hälfte“\\[.1cm]
\noindent\textbf{Laufweg außen Startende}:\\
\nicefrac{1}{4} Chase around the Set + \nicefrac{1}{2} Hey + \nicefrac{1}{4} Chase around the Set\\[.1cm]
\noindent\textbf{Laufweg innen Startende}:\\
Damen: linkschultrig Partner passieren + \nicefrac{1}{2} Chase + 3 weitere Schultern in Hey passieren\\
Herren: \nicefrac{1}{2} Hey + \nicefrac{1}{2} Chase 
\clearpage
\begin{center}
	\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{img/double_dolphin_weasel_reel}}%
	%	\includegraphics[width=1.1\textwidth]{external-img/aviator}
\end{center}
\dancedifficultmarker
...
\danceinstructionsel
1 -- 6 	& Paar 1 walzert abwärts\\
7 -- 12 & Paar 1 walzert zurück auf ihren Platz\\
1 -- 12 & Paar 1 Cast Down, P2 Lead Up.\\
& (\textit{Hier kann beliebig lange gewalzert werden, wenn am Ende das Cast \& Lead rechtzeitig passiert...})\\
\danceinstructionsel
& \textit{Ab jetzt machen die Bäumchen alles mit!}\\
1 -- 12 & Paare Box the Gnat mit rechts.\\
13--24 	& Paare Box the Gnat mit links.\\
\danceinstructionsel
...
\iffalse\subsection{Dutch Crossing}\fi % fool texstudio into displaying subsections
\dancename{Dutch Crossing}
\danceinfo{Tanz für 8 Paare in 4x4 aufgestellt}
\origininfo{Ernst van Brakel}{unterschiedlich}{}
\textit{Aufstellung: Eine Linie aus 2 Paaren (H links, D rechts) steht einer Linie aus zwei Paaren gegenüber. dahinter nochmal genauso 2 Linien.\\Paare schauen in Richtung des anderen Paars, Partner:in neben sich.}
\danceinstructionsbegin
1 -- 8 & Zwei-Hände Kette mit rechts mit Gegenüber im eigenen Minor Set starten.\\
9 -- 16 & Halbe Hey for Four (Entlang der Richtung des letzten Handwechsels), Mitten starten rechtsschultrig.\\
1 -- 8 & Im neuen Minor Set: \nicefrac{1}{2} Setkreis nach \textbf{rechts}, dann Fall back mit Partner:in\\
9 -- 16 & Set zueinander \& Turn rechts\\
\danceinstructionsel
1 -- 8 & Zwei-Hände Kette mit links mit Gegenüber im eigenen Minor Set starten.\\
9 -- 16 & Halbe Hey for Four (Entlang der Richtung des letzten Handwechsels), Mitten starten linksschultrig.\\
1 -- 8 & Mit Minor Set: \nicefrac{1}{2} Setkreis nach links, dann Fall back mit Partner:in\\
9 -- 16 & Set zueinander \& Turn rechts (\textit{alle zuhause})\\
\danceinstructionsel
& \textbf{Dutch Crossing:}\\
& \textit{Die Diagonalen tanzen diagonale Heys for Four, alle anderen eine Grand Chain:}\\
1 -- 4 & \nicefrac{1}{2} Rechthandstern in den Minor Sets\\
5 -- 8 & \nicefrac{1}{2} Linkhandstern in der Mitte, Ecken Set, Grand Chain linkshändig eine Position weiter\\
9 -- 12 & \nicefrac{1}{2} Rechthandstern in fremden Minor Sets\\
13--16 & \nicefrac{1}{2} Linkhandstern in der Mitte, Ecken Set, Grand Chain linkshändig eine Position weiter\\
 & \textit{Alle diagonal gespiegelt von zuhause}\\
1 -- 16 & Wiederholen, (\textit{alle zuhause})\\
\danceinstructionsel
1 -- 8 & Paare Ronde\\
9 -- 16 & Paare Dos-a-dos\\
1 -- 8 & 1\nicefrac{1}{4} Setkreis im Minor Set\\
9 -- 16 & Dos-a-dos mit Gegenüber
\dancedifficultmarker
\danceinstructionsend
\textit{Nach einer Strophe tanzt man von einer neuen Stelle im Minor Set. \\Alle Linienfiguren sind um 90° gedreht. \\In jeder Strophe tanzt man im Minor Set mit den selben Menschen.}
...
\dancename{The Fandango}
\iffalse\subsection{The Fandango}\fi % fool texstudio into displaying subsections
\origininfo{Thompson}{The Fandango}{Thompson}
\danceinfo{Longways for three Couples}
\danceinstructionsbegin
1 -- 16 & P1 rechte Handtour \& (long) Cast Down, P2 Lead Up\\
1 -- 16 & P1 linke Handtour \& (long) Cast Down, P3 Lead Up\\
\danceinstructionsel
1 -- 16 & Hands six, Kreis nach links und zurück (slipping)\\
1 -- 12 & P1 Lead Up (nach ganz oben) + Cast Down (auf Pos. 2, P3 Lead Down)\\
13--16 & P1 Turn über oben\\
\danceinstructionsel
1 -- 8 & P1 Ronde nach jeweils diagonal rechts\\
9 -- 16 & P1 Ronde\\
1 -- 8 & P1 \nicefrac{3}{4}Ronde nach diagonal links, geht über in...\\
9 -- 16 & P1 1\nicefrac{1}{2} Ronde, dabei schneller werdend (alle enden proper)\\
\danceinstructionsel
1 -- 16 & P1 nach jeweils links Figure-Eight durch die dortigen Paare, daraus kommend, passiert sich P1 in der Mitte linksschultrig\\
1 -- 12 & P1 startet (H nach unten, D nach oben) in eine linksschultrige Hey across the set\\
13--16 & P1 Lead Down, P3 Lead Up (außen)
\dancemediummarker
\danceinstructionsend
...
\origininfo{Colin Hume (2002)}{Felicity}{Dave Brown (2002)}
\danceinfo{Longway for four Couples\\\nicefrac{3}{4}Takt}
\danceinstructionsbegin
\textbf{Takte} & ~\\
1 -- 2 	& D1 cast down, D2 move up, H4 cast up, H3 move down\\
3 -- 4 	& Pos 2 \& 3 Platzwechsel rechtsschultrig\\
5 -- 8  & Mittlere Paare: volle Rechthandmühle, Äußere Paare Box the Gnat mit rechten Händen.\\ 
1 -- 8  & Wiederholen (Immer Positionen nicht Rollen)\\
\danceinstructionsel
1 -- 4  & Dos-a-dos mit Partner\\
5 -- 8  & \nicefrac{1}{2} Großer Setkreis\\
\danceinstructionsel
1 -- 4  & Äußere Paare starten eine 4-Hände Kette (mit rechts starten), Mitten machen nur 3-Hände Kette und starten erst ab Takt 2 mit links die Kette mit den ankommenden Äußeren. (Ein Händewechsel pro Takt)\\
...
\dancename{General Grooviness of the Universe}
\iffalse\subsection{General Grooviness of the Universe}\fi % fool texstudio into displaying subsections
\origininfo{Brooke Friendly \& Chris Sackett}{March for Warren}{Peter Barnes}
\danceinfo{Duple Minor}
\danceinstructionsbegin
1 -- 8 & Setkreis (UZS)\\
9 -- 16 & Linkhandstern zurück\\
17--20 & Paare \nicefrac{1}{2} linke Handtour\\
\danceinstructionsel
1 -- 8 & Setkreis (\textbf{GUZS})\\
9 -- 16 & Rechthandstern zurück\\
17--20 & Paare \nicefrac{1}{2} rechte Handtour\\
\danceinstructionsel
1 -- 8 & Zwei-Hände-Kette (links mit Partner beginnend)\\
9 -- 16 & Paare linke Handtour\\
17--20 & Turn rechts\\
\danceinstructionsel
1 -- 8 & Paare rechtschultriges Siding\\
9 -- 16 & Paare Dos-a-dos (als erstes linksschultrig)\\
17--20 & Paare \nicefrac{1}{2} Ronde
\dancemediummarker
\danceinstructionsend
...
\dancename{The Installation}
\origininfo{Thompson}{The Installation}{Thompson}
\iffalse\subsection{The Installation}\fi % fool texstudio into displaying subsections
\danceinfo{Longway for three couples}
\danceinstructionsbegin
1 -- 16 & Mirror Crossover Heys (P1 kreuzt und startet nach innen)\\
1 -- 16 & Mirror Crossover Heys (P1 kreuzt zurück)\\
\danceinstructionsel
1 -- 8 & P1 Half-Figure-Eight durch P2\\
9 -- 16 & Alle Ronde\\
1 -- 8 & P3 Half-Figure-Eight durch P2\\
9 -- 16 & Alle Ronde\\
\danceinstructionsel
1 -- 8 & Hands-six: 2x Set Rechts\\
9 -- 16 & 3-Hände Kette: P1 miteinander, P2 \& P3 auf Linie startend)\\
1 -- 16 & Wiederholen (Alle zuhause, P1 \& P3 improper)\\
\danceinstructionsel
1 -- 8 & P1 linksschultrig passieren, P1 Cast \& P2 Lead\\
9 -- 16 & P1 Half-Figure-Eight durch P2 (nach oben)\\
1 -- 8 & P1 \& P3 4-Hände Kette\\
9 -- 16 & P1 \& P3: Partner passieren, P1 Cast, P3 Lead \\
& (fühlt sich insgesamt an wie 5-Hände Kette)\\
\dancedifficultmarker
\danceinstructionsend
...
\origininfo{Pat Shaw}{John Tallis' Canon}{Pat Shaw}
...
1 -- 6 	& Meet \& Fallback\\
7 -- 12	& P2 gatet P1\\
1 -- 12 & 1er gehn nach rechts in eine Hey across\\
1 -- 6 	& \textit{Longway:} \\
& Paar 1 rechtschultriger Gypsy\\
& \textit{3 Paare:}\\
...
1 -- 8 & Obere und untere Seitenpaare Setkreis, Hauptpaar Cast Back Up\\
...
\iffalse\subsection{Meandering Matilda}\fi % fool texstudio into displaying subsections

\dancename{Meandering Matilda}
\origininfo{Loretta Holz}{Matilda's Rant}{Roger Davidson}
\danceinfo{Duple Minor, P1 improper}
\danceinstructionsbegin
1 -- 32 & D2: Full Figure Eight auf anderer Seite des Sets, startet mit rechter Schulter um D1, ab 17 folgt H1 hinter D2, bis sie wieder auf der eigenen Seite sind\\
1 -- 32 & D1: Full Figure Eight auf anderer Seite des Sets, startet mit rechter Schulter um H1, ab 17 folgt H2 hinter D1, bis sie wieder auf der eigenen Seite sind (Fortschritt)\\
\danceinstructionsel
1 -- 8 & Herren Platzwechsel rechtsschultrig (nach außen schauen)\\
9 -- 16 & Damen Platzwechsel linksschultrig (nach außen schauen)\\
17--24 & Gate mit Nachbarn auf Linie (Herren rückwärts)\\
25--32 & Paare \nicefrac{1}{2} Gypsy rechtsschultrig\\
\danceinstructionsel
1 -- 8 & Halbe Rechthandmühle\\
9 -- 16 & Paare halbe rechte Handtour\\
17--32 & Wiederholen
\dancemediummarker
\danceinstructionsend
\textit{Tanzschritt: Schritt rechts, links, rechts, auf rechts hüpfen. Dann links, rechts, links, auf links hüpfen.}
...
\iffalse\subsection{The MollyAndrew}\fi % fool texstudio into displaying subsections

\dancename{The MollyAndrew}
\origininfo{Chris Sackett \& Brooke Friendly}{Saturday Morning Waltz}{Dave Wiesler}
\danceinfo{Sicilian Circle, \nicefrac{3}{4}}
\danceinstructionsbegin
\textbf{Takte}\\
1 -- 4 & P1 (schaut im UZS) Half Figure Eight durch P2\\
5 -- 8 & Gegenüberstehende: ganze Handtour (mit passender Hand: 1er innen)\\
9 -- 12 & P2 Half Figure Eight durch P1 (aber als erstes außen herum, dann innen kreuzend)\\
13--16 & Gegenüberstehende: ganz Handtour (mit passender Hand: 1er innen)\\
\danceinstructionsel
1 -- 4 & Mirror Dos-a-dos (1er innen)\\
5 -- 8 & Setkreis\\
9 -- 12 & Herren Platzwechsel, Damen Platzwechsel (beide rechtschultrig)\\
13--16 & Paare Ronde, dann zu neuem Set wenden
\dancemediummarker
\danceinstructionsend
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Pengwern Valley Galop
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage

\dancename{Pengwern Valley Galop}
\iffalse\subsection{Pengwern Valley Galop}\fi % fool texstudio into displaying subsections
\origininfo{Pat Shaw}{???}{???}
\danceinfo{Sicilian Circle, Mixer\\Herren schauen GUZS, Damen UZS}
\danceinstructionsbegin
1 -- 8 & Sich anschauende Personen (nicht Paare): Beide Hände geben \& Seitgalopp: Innen stehende nach außen und zurück, Außen stehende nach innen und zurück.\\
9 -- 16 & Umdrehen und mit dieser Person das selbe (innen nach außen und andersherum) (Danach so stehen bleiben.)\\
\danceinstructionsel
1 -- 8 & Paare geben sich die näheren Hände: Handtour \\
9 -- 16 & Paare Handtour zurück mit anderer Hand\\
1 -- 8 & Dos-a-dos mit gerade anschauender Person (erste Seitgalopp Person)\\
9 -- 16 & Klatschen: Eigen, Rechts, Eigen, Links, dann rechtsschultrig passieren
\dancemediummarker
\danceinstructionsend
...
\dancename{Pterocotta}
\origininfo{Gary Roodman}{Pterocotta}{Dave Wiesler}
\iffalse\subsection{Pterocotta}\fi % fool texstudio into displaying subsections
\danceinfo{Duple Minor Longways}
\danceinstructionsbegin
...
\danceinfo{Longway for as many as will}
\danceinstructionsbegin
1--8 & Paar 1 Gypsy, Paar 2 Balancé vor und zurück dann Cast up hinter die Position von Paar 1\\
9--16 & H1 \& Dame 1 passieren sich rechtsschultrig, dann H1 und D2 Gypsy, H2 und D1 Gypsy (jeweils rechtsschultrig)\\
\danceinstructionsel
1--16 & Hey for Four, Contras rechtsschultrig beginnend, endet in einer Line of four\\
...
\dancename{The Pursuit}
\origininfo{Playford/Pat Shaw}{The Pursuit}{Playford}
\iffalse\subsection{[The Pursuit]}\fi % fool texstudio into displaying subsections
\danceinfo{Duple Minor}
\danceinstructionsbegin
1 -- 16 & H1 Hey mit D1 \& D2 (mit D2 rechtschultrig starten), am Ende Platzwechsel mit H2 auf Linie (H1 außen)\\
1 -- 16 & D1 gespiegelt wiederholen (mit H1, linkschultrig starten)\\
\danceinstructionsel
1 -- 8 & P1 Lead Down \& Cast Up (durch fremdes Paar)\\
9 -- 16 & Paare Ronde\\
1 -- 16 & P1 Figure Eight durch P2
\danceeasymarker
\danceinstructionsend
...
\dancename{Ruby-Crowned Kinglet}
\origininfo{Brooke Friendly \& Chris Sackett (2011)}{}{}
\iffalse\subsection{Ruby-Crowned Kinglet}\fi % fool texstudio into displaying subsections
\danceinfo{Longway for six, \nicefrac{3}{4}-Takt}
\danceinstructionsbegin
1 -- 12  & Paar 1 1,5 rechte Handtour\\
13 - 24  & Paar 1 (improper) 1,5 linke Handtour mit Paar 2\\
25 - 36  & Paar 1 (improper) 1,5 rechte Handtour mit Paar 3\\
         & Paar 2 1,5 rechte Handtour\\
\danceinstructionsel
1 -- 12  & halber Setkreis\\
13 - 24 & Paare Cecil Sharp Siding rechts- und linksschultrig\\
\danceinstructionsel
1 -- 12  & FC linke Handtour; Paar 3 (Mitte) eigenes rechts durch das jeweils andere Paare und links um leere Position, rechtsschultrig passieren (analog zu Gingerbread)\\
13 - 24  & SC linke Handtour; Paar 3 links um leere Position auf den eigenen Platz\\
\danceinstructionsel
1 -- 12  & Balancé vor \& zurück, Platzwechsel\\
13 - 24  & Dos-à-Dos
\dancedifficultmarker
\danceinstructionsend
...
\danceinfo{Longway for as many as will}
\origininfo{Chris Sackett \& Brooke Friendly}{Scales of Justice}{Shira Kammen \& Roguery}
\danceinstructionsbegin
...
5 -- 8 	& Paare ganze linke Handtour (recht schnell)\\
...
\iffalse\subsection{Sea Shadows}\fi % fool texstudio into displaying subsections
\dancename{Sea Shadows}
\danceinfo{Longways for three Couples}
\origininfo{Chris Sackett \& Brooke Friendly}{Your Slip is Showing}{Chris Sackett}
\danceinstructionsbegin
\textbf{Takte} & \\
1 -- 4 & Set \& link für 3 Paare\\
5 -- 8 & Wiederholen (Set um 180° gedreht)\\
\danceinstructionsel
1 -- 2 & Set rechtschultrig am Parter vorbei, nach rechts drehen\\
3 -- 4 & \nicefrac{1}{4} Single File Circle\\
5 -- 8 & Wiederholen (alle zuhause)\\
\danceinstructionsel
& \textit{alle Platzwechsel rechtschultrig}\\
1 -- 2 & Obere FC (H1 \& D2) Platzwechsel\\
3 -- 4 & Obere SC Platzwechsel \& P3 Platzwechsel\\
5 -- 6 & Untere SC rechtsschultriger Platzwechsel\\
7 -- 8 & Untere FC Platzwechsel \& P2 (oben) Platzwechsel\\
\danceinstructionsel
& \textit{Escalating Circles (schnell!)}\\
1 -- 2 & P2 (oben) Ronde\\
3 -- 4 & Obere zwei Paare (P2 \& P3) Setkreis\\
5 -- 8 & Hands six: \nicefrac{1}{2} Setkreis \& Turn links\\
\danceinstructionsel
1 -- 2 & P1 (oben) Ronde GUZS\\
3 -- 4 & Obere zwei Paare (P1 \& P3) Setkreis GUZS\\
5 -- 8 & Hands six: \nicefrac{1}{2} Setkreis GUZS \& Turn rechts
\dancedifficultmarker
\danceinstructionsend
...
\iffalse\subsection{T.A.G.}\fi % fool texstudio into displaying subsections

\dancename{T.A.G.}
\origininfo{Roger Whynot}{}{}
\danceinfo{Longways for four Couples}
\danceinstructionsbegin
1 -- 16 & P1 Lead Down \& Lead back Up\\
1 -- 8  & D1 gefolgt von D2,3 und 4 cast in eine Rechthandmühle, Herren ebenso in eine Linkhandmühle\\
9 -- 16 & Aus den Mühlen in die Mitte kommend kreuzen alle auf die andere Seite (D1, H2, D2, H2...)\\
1 -- 8 & Alle kreuzen mühlend wieder zurück auf ihre Seite\\
9 -- 16 & P1 Lead up aus den Mühlen (andere folgen)\\
1 -- 8 & P1 Cast down ans Ende des Longways (andere folgen)\\
9 -- 16 & P1 macht Tore, P2,3 und 4 Lead Up (2, 3, 4, 1)
\dancemediummarker
\danceinstructionsend
\textit{Das kreuzen aus den Mühlen ist immer vom unteren Ende der Mühle nach oben (und auf die andere Seite).}
...
\dancename{Take a Dance}
\iffalse\subsection{Take a Dance}\fi % fool texstudio into displaying subsections
\origininfo{Johnson/Neil}{Take a Dance/Ore Boggy}{Johnson/Neil} 
\danceinfo{Longway, Duple Minor}
\danceinstructionsbegin
1 -- 8 & P1 Lead Down \& Cast Up\\
9 -- 16 & P1 Ronde\\
1 -- 8 & P2 Lead up \& Cast Down\\
9 -- 16 & Ronde\\
\danceinstructionsel
1 -- 8 & P1 rechtsschultrig passieren, dann Cast Down, P2 Lead Up\\
9 -- 16 & P1 Half Figure 8 durch P2\\
1 -- 16 & 4-Hände Kette mit Partner startend
\danceeasymarker
\danceinstructionsend
...
1 -- 8 & Linkshandstern ganz herum. Am Ende Partner linke Hand geben.\\
9 -- 16 & Partner halbe linke Handtour, dann Turn rechts.\\
\danceinstructionsel

1 -- 24 & (8) Halbe Hey + (4) Gypsy + (8) Halbe Hey + (4) Sortieren:\\
& (\textit{oder: (8) + (8) + (8) + (0), wenn alle fit sind})\\
 & FC starten eine halbe Hey rechtsschultrig. SC starten dann mit eigenem Partner linkschultrig.\\
 & Nach einer halben Hey begegnen sich die FC und tanzen einen halben Gypsy rechtsschultrig (ergo eine halbe Drehung), dann eine weitere halbe Hey. Als letzter Teil dieser Hey passieren sich die FC, dann ...\\
 %& praktische Aufteilung: \textbf{8} Halbe Hey - \textbf{4} FC Gypsy - \textbf{8} - \textbf{4} FC passieren und bereit für Single File Circle.\\
1 -- 8 & Ganzer Setkreis ohne Anfassen (original: Single file circle)\\
\dancedifficultmarker
\danceinstructionsend
\vspace{-0.4cm}
\noindent
\textit{Wie Colin Hume schon anmerkt, darauf achten die Hey rechtwinklig zum Longway zu tanzen, nicht schräg. Es hilft, wenn die SC einen Schritt nach links hinten machen, um von dort in die Hey zu starten.}
...
\origininfo{inspiriert von Emma(2009)}{The Ships Cook}{Samuel Sim}
\iffalse\subsection{[The Ship's Cook]}\fi % fool texstudio into displaying subsections
\danceinfo{Kreis GUZS, Herren innen, Damen außen}
\danceinstructionsbegin
1 -- 8 & Paare beide Hände geben: 8 Seitgaloppschritte GUZS\\
9 -- 12 & Alle Drehung (Damen über links, Herren über rechts), auf 12 Klatschen\\
13 -- 16 & Alle Drehung zurück, auf 16 Klatschen\\
\danceinstructionsel
1 -- 8 & Damensolo\\
9 -- 16 & Herrensolo\\
1 -- 8 & Paare Seitgalopp im UZS\\
9 -- 16 & Drehung hin und zurück (Damen erst rechts, Herren erst links) und jeweils klatschen\\
\danceinstructionsel
1 -- 8 & Damen weben: linkschultrig an ihrem Partner vorbei, um den nächsten Herren rechts, vor dem übernächsten zum stehen bleiben (recht nah).\\
9 -- 16 & Herren weben: rechtsschultrig an der fremden Damen vorbei nach links, hinter der nächsten vorbei und vor eigener Dame stehen bleiben.\\
1 -- 8 & Paare Swing (eher einhaken, als Paartanzhaltung)\\
9 -- 16 & Mit Person diagonal links Swing (neue Paare)
\dancemediummarker
\danceinstructionsend
...
\dancename{Tidewater}
\iffalse\subsection{Tidewater}\fi % fool texstudio into displaying subsections
\origininfo{Jenna Simpson}{Flashbacks/Live and Learn}{Janet Muse}
\danceinfo{Duple Minor, \nicefrac{3}{4} Takt}
\danceinstructionsbegin
\textbf{Takte} & \\
& \textbf{\textit{Linkskurven}}\\
1 -- 2 & \nicefrac{1}{2} Setkreis (UZS)\\
3 -- 4 & Paare rechtsschultriger Platzwechsel\\
5 -- 6 & SC Pos. Platzwechsel, dann FC Pos. (beide rechtsschultrig)\\
7 -- 8 & Paare \nicefrac{1}{2} Ronde (UZS) \\
\danceinstructionsel
& \textbf{\textit{Rechtskurven}}\\
1 -- 2 & \nicefrac{1}{2} Setkreis nach rechts (\textbf{GUZS})\\
3 -- 4 & Paare linksschultriger Platzwechsel\\
5 -- 6 & FC Pos. Platzwechsel, dann SC Pos. (beide linksschultrig)\\
7 -- 8 & Paare \nicefrac{1}{2} Ronde (\textbf{GUZS}) \\
\danceinstructionsel
1 -- 4 & P1 linkschultrig passieren \& Cast Down in Mitte von Line of Four\\
5 -- 6 & Line of Four Lead Up, Fall back bending the line\\
7 -- 8 & \nicefrac{1}{2} Setkreis\\
1 -- 4 & P2 Half Figure Eight durch P1\\
5 -- 8 & Circular Hey, 3 Plätze, mit Partner rechtsschultrig starten
\dancemediummarker
\danceinstructionsend
...
\iffalse\subsection{Turning of the Hour}\fi % fool texstudio into displaying subsections
\dancename{Turning of the Hour}
\origininfo{Margaret \& Jeff Bary}{Turning of the Hour}{Rachel Bell}
\danceinfo{Duple Minor, \nicefrac{3}{4} Takt}
\danceinstructionsbegin
\textbf{Takte} & \\
1 -- 4 & FC Set rechts \& \nicefrac{1}{2} rechte Handtour\\
5 -- 8 & FC Set rechts \& \nicefrac{1}{2} linke Handtour\\
1 -- 4 & Paare Set rechts \& \nicefrac{1}{2} Ronde\\
5 -- 8 & \nicefrac{1}{2} Setkreis, dann Paare \nicefrac{1}{2} Ronde\\
\danceinstructionsel
1 -- 4 & Mirror Dos-a-dos P2 innen\\
5 -- 8 & \nicefrac{1}{2} Double Figure Eight (P1 Cast \& Cross up, P2 Cross \& Cast Up)\\
1 -- 4 & Rechthandstern (Hände gefasst lassen)\\
5 -- 6 & Balance in die Setmitte\\
7 -- 8 & Cast über linke schulter in \nicefrac{1}{2} Single File Circle GUZS
\dancemediummarker
\danceinstructionsend
...
\dancename{Under the Influence}
\iffalse\subsection{Under the Influence}\fi % fool texstudio into displaying subsections
\origininfo{Jenna Simpson}{Tom Kruskals}{Amelia Mason \& Emily Troll}
\danceinfo{Longways for Four Couples, P1 \& P3 improper}
\danceinstructionsbegin
& \textbf{In Sets oben \& unten:}\\
1 -- 4 & Balance the Ring\\
5 -- 8 & Petronella Turn eine Pos. nach rechts (GUZS)\\
& \textbf{Im ganzen Set}\\
9 -- 16 & Balance the Ring \& Petronella Turn eine Pos. nach rechts\\
1 -- 4 & Balance the Ring\\
5 -- 8 & Paare schnelle Ronde\\
9 -- 16 & Hands-eight: halber Setkreis (UZS)\\
\danceinstructionsel
1 -- 16 & Double Dolphin Heys:\\
& P1 \& P4 (in der Mitte) tanzen (skip change) jeweils nach links durch die Äußeren eine halbe Dolphin Hey, dann auf die jeweilige Seite des Sets und wieder nach links eine halbe Dolphin Hey und enden auf Startpositionen\\
& Äußere Paare tanzen eine „normale“ Dolphin Hey across the Set\\
\danceinstructionsel
1 -- 8 & Oben \& unten: Mirror-dos-a-dos (Mitten erst Innen)\\
9 -- 16 & Oben \& unten: Setkreis
\dancedifficultmarker
\danceinstructionsend
\textit{Schnörkelei: Innere (Delphin) Paare der Hey tanzen mit näheren Händen gefasst: Aus dem Setkreis kommend gefasst lassen, außen Plätze und Hände wechseln (wie genau muss man selbst schauen, und dann weiter bis man sich im Mirror-dos-a-dos trennt...}
...
5 -- 8 & Set rechts (z.B. zueinander, oder zum anderen Paar)\\
...
\dancename{Westward Bound}
\origininfo{Philippe Callens (2002)}{Waiting for Fish}{Susie Secco}
\iffalse\subsection{Westward Bound}\fi % fool texstudio into displaying subsections
\danceinfo{Longways for four Couples, Becket, \nicefrac{3}{4} Takt}
\danceinstructionsbegin
\textbf{Takte} & \\
1 -- 4 & In Minor Sets: Alle in Setmitte schauend: Set advancing \& Turn rechts zurück\\
5 -- 8 & In Minor Sets: Setkreis nach links ganz herum\\
\danceinstructionsel
1 -- 4 & First Corner Paare: Set rechts auf Corner zu, rechtsschultrig passieren und auf diagonalposition gehen\\
5 -- 8 & Alle Damen: \nicefrac{1}{2} Chase around the Set (UZS)\\
\danceinstructionsel
1 -- 4 & (Neue) Paare zueinander schauend: Zwei Anstellschritte nach rechts, dann nach links\\
5 -- 8 & \nicefrac{1}{2} Hey for Four auf den Seitenlinien (rechtsschultrig mit (neuem) Partner starten)\\
\danceinstructionsel
1 -- 4 & Paare (langsame) rechte Handtour (Hände gefasst lassen)\\
5 -- 8 & Paare auf 1st Corner Position (aktuell Becket-improper) geführte Half-Figure-Eight durch Paar gegenüber
\dancedifficultmarker
\danceinstructionsend
...
\dancename{Whately Barn}
\origininfo{Gary Roodman}{}{}
\iffalse\subsection{Whately Barn}\fi % fool texstudio into displaying subsections
\danceinfo{Duple Minor, \nicefrac{3}{4} Takt}
\danceinstructionsbegin
\textbf{Takte} & \\
1 -- 2 & FC Platzwechsel rechtsschultrig\\
3 -- 4 & Halber Setkreis\\
5 -- 6 & SC Platzwechsel rechtsschultrig\\
7 -- 8 & Halber Setkreis\\
\danceinstructionsel
1 -- 2 & Paare passieren rechtsschultrig + Turn links\\
3 -- 4 & Paare linke Handtour\\
5 -- 6 & Linkhandstern halb herum\\
7 -- 8 & Turn rechts (alle improper)\\
\danceinstructionsel
1 -- 4 & Balance zurück, dann Dos-a-dos\\
5 -- 6 & Circular Hey, zwei Plätze\\
7 -- 8 & Paare halbe Ronde\\
1 -- 4 & P2: Cast Down, \textbf{Cross} Up, Cast ans Ende einer Line of Four. P1: Lead Up, Cast Down, halbe Ronde in Mitte von Line of Four\\
5 -- 6 & Balance zurück\\
7 -- 8 & P2 gatet P1 zurück in die Linie (P1 vorwärts, P2 rückwärts)
\dancedifficultmarker
\danceinstructionsend
...
\dancename{Whiskeyjack}
\origininfo{Christine Robb}{Ichabod's Last Ride}{Jay Edmunds}
\iffalse\subsection{Whiskeyjack}\fi % fool texstudio into displaying subsections
\danceinfo{Duple Minor, 1er improper}
\danceinstructionsbegin
1 -- 8 & Alle: Set rechts und Platzwechsel mit Drehung rechts (Trip to Paris), dann nach außen schauen\\
9 -- 16 & Nachbarn Lead out, umdrehen Lead back in\\
1 -- 8 & Paare Set \& Turn rechts\\
9 -- 16 & Paare passieren sich rechtsschultrig, dann California Twirl mit Nachbarn\\
\danceinstructionsel
1 -- 8 & Double Mad Robin, Herren als erstes vorwärts. \\
9 -- 16 & Double Mad Robin noch ein Viertel weitertanzen, dann Hey for Four mit Herren linksschultrig startend und in fortgeschritten Positionen enden (selbe wie vor Hey).\\
1 -- 8 & Paare Ronde
\dancedifficultmarker
\danceinstructionsend
