...
\danceinstructionsbegin
1 -- 8 & Setkreis GUZS\\
1 -- 2 & Mit Nachbarn nach rechts zum nächsten Set weitergehen\\
...
\danceinstructionsel
\danceinstructionsel
1 -- 8 & Nachbarn: Swing, Damen enden rechts, Herren enden links\\
1 -- 16 & Hey for Four, Herren starten mit linker Schulter in Mitte.\\
 & \textit{Nachdem man wieder im Set angekommen ist, startet man die nächste Strophe mit dem Paar, das gerade nicht in der Hey war.}
\dancedifficultmarker
\danceinstructionsend
...
\danceinstructionsbegin
\textbf{Takt} & \\
1 -- 2 & Herren linke Handtour \\
3 -- 4 & Herren Set Rechts (mit noch gefasster Hand)\\
5 -- 6 & Herren auswenden auf Position von Nachbar, während Damen: Set links aufeinander zu.\\
7 -- 8 & Herren aus dem Cast kommend: rechte Handtour ca. \nicefrac{3}{4}, während Damen Turn rechts zurück auf Platz(können die Herren dabei anschauen). Alle sind jetzt wieder auf den Startplätzen\\
\danceinstructionsel
\danceinstructionsel
1 -- 2 & Damen rechte Handtour \\
3 -- 4 & Damen Set Links (mit noch gefasster Hand)\\
5 -- 6 & Damen auswenden auf Position von Nachbar, während Herren: Set rechts aufeinander zu.\\
7 -- 8 & Damen aus dem Cast kommend: linke Handtour ein bisschen mehr als ganz herum, während Herren Turn rechts zurück und außen an Line of Four, Damen enden innen in Line of Four, Partner anschauend\\
\danceinstructionsel
1 -- 4 & Halbe Hey, am Ende wieder in Longway landen, 1er unten, 2er oben. \\
5 -- 6 & Halber Setkreis\\
7 -- 8 & 1er gaten zweier nach oben, dann zum fremden set(quasi aus dem Gate)\\
1 -- 4 & Doppeltes Cast \& Lead mit fremdem Set(1er zuerst Cast), quasi Mirror-Dos-a-dos mit Blickrichtungswechsel (dabei als erstes zweier innen).\\
