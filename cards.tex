...
\newcommand{\danceeasymarker}{
	\begin{tikzpicture}[remember picture, overlay]
		\node[anchor=south, xshift=0cm, yshift=0.5cm, inner sep=0] at (current page.south){\pgfornament[width=6cm]{80}};
	\end{tikzpicture}
}
\newcommand{\dancemediummarker}{
	\begin{tikzpicture}[remember picture, overlay]
		\node[anchor=south, xshift=0cm, yshift=0.5cm, inner sep=0] at (current page.south){\pgfornament[width=7cm]{83}};
	\end{tikzpicture}
}
\newcommand{\dancedifficultmarker}{
\begin{tikzpicture}[remember picture, overlay]
	\node[anchor=south, xshift=0cm, yshift=0.4cm, inner sep=0] at (current page.south){\pgfornament[width=6cm]{84}};
\end{tikzpicture}
}
...
\danceinstructionsend
\origininfo{Philippe Callens}{The Red Star Line}{von Kathy Talvitie}
\dancemediummarker
...
\danceinstructionsbegin
&\textbf{Figuren:}\\
E-L& Einzel Links: Schritt links, mit rechts tippen\\
E-R&Einzel Rechts: Schritt rechts, mit links tippen\\
D-L&Doppel Links: Schritt nach links, kreuz links, und tippen\\
D-R&Doppel Rechts: Schritt nach rechts, kreuz rechts, und tippen\\
\danceinstructionsel
&\textbf{Tanz}\\
...
\danceinfo{Longway for as many as will}
\danceinstructionsbegin
1 -- 8 & Dosado mit der Person diagonal rechts(Sets sind dabei egal)\\
1 -- 8 & Herren Dosado auf der Linie\\
9 -- 16 & Damen Dosado auf der Linie\\
\danceinstructionsel
1 -- 8 & Paar 1 Swing am Ende davon eine Line of Four nach unten bilden\\
...
\danceinstructionsel
\danceinstructionsel\danceinstructionsel % for page break
...
\danceinfo{Longway for as many as will\\¾ Takt, doppelter Fortschritt}
\danceinstructionsbegin
Takt 	& \\
...
\danceinstructionsel
\textbf{Refrain:}&\\
1--6	& 1. Nebenpaar ganze Ronde, 2. Nebenpaar Set \& Turn Rechts, Hauptpaar geht außen ein Viertel im Uhrzeigersinn weiter \\
7--8 	& Hauptpaar passiert in der Mitte rechtsschultrig\\
9--14 	& 2. Nebenpaar ganze Ronde, 1. Nebenpaar Set \& Turn Rechts, Hauptpaar geht außen ein Viertel im Uhrzeigersinn weiter\\
...
\danceinstructionsbegin
Takte&\\
1 -- 8 	& D2 cast up um D1 in Figure of Eight um D1 und H2, H2 verfolgt bis beide wieder auf der Ausgangsposition ankommen\\
...
\danceinfo{Longway for as many as will, Kanon}
%\danceinstructionsbegin
%\dancedifficultmarker
...
\danceinstructionsbegin
\textbf{Teil}&\textbf{A1:}\\
1 -- 8 	& Mirror-image-Hecken auf den Seitenlinien. Die 1er gehen durch die 2er, die 3er gehen durch die 4er. Drei Schritte für jeden Wechsel. Die Paare können wann immer möglich Handfassung aufnehmen.\\
\textbf{Teil}& \textbf{A2:}\\
1 -- 4 & 1er lead down durch die anderen Paare, turn single und lead up\\
5 -- 8 & Invert Lines: Die 1er machen einen cast down auf die Position der 4er. Die anderen Paare folgen ihnen, so dass am Ende die 1er mit den 4ern und die 2er mit den 3ern die Plätze getauscht haben.\\
&\\
\textbf{Teil} & \textbf{B:}\\
...
13--16 	& In den Sets durchfassen zum Viererkreis und halb herum im Uhrzeigersinn\\
\dancedifficultmarker
\danceinstructionsend
...
\danceinfo{Playford für Vier Paare, Aufstellung:\\H~~H~~D~~D\\D~~D~~H~~H}
\danceinstructionsbegin
\textbf{Strophe} & \textbf{I} \\
...
\dancename{Mulberry Garden (Berlin)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Playing in the Field(s)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage

\dancename{Playing in the Field(s)}
\iffalse\subsection{Playing in the Field(s)}\fi % fool texstudio into displaying subsections
\danceinfo{Grand Square}
...
5 -- 8 & Die Paare wenden sich zueinander und nehmen Doppelhandfassung auf, der Herr schiebt die Dame in die Seitenmitte\\
...
\origininfo{Christine Robb}{Tom Kruskal's}{von ???}
\danceinfo{Longway for as many as will}
\danceinstructionsbegin
1 -- 8	& Setkreis links \\
1 -- 8	& First Corner rechte Handtour \\
...
\danceinstructionsel
1 -- 8 	& Paar 1 wendet auf den unteren Platz aus, Paar 2 Lead Up und Cast Down an die Enden einer Line of Four mit Paar 1 in der Mitte\\
...
%	\begin{flushright}
	...
	%	\end{flushright}
%\end{textblock}
\origininfo{Brooke Friendly \& Chris Sackett}{Ursa Minor}{von Roguery(2010)}
...
\textbf{Teil I} &\\
%\danceinstructionsel
1 -- 8 	& Beide Tänzer lösen die rechten Hände und die Dame umrundet ihren Herrn an der linken Hand, um sich anschließend zu dem Herrn des nachfolgenden Paares zu begeben. Dort dreht sie sich in die Kiekbuschfassung ein.\\
\danceeasymarker
\danceinstructionsend
