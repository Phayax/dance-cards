...
\origininfo{Jenna Simpson (2017)}{Dave Wiesler (2006)}{The Sunlight Room}
\iffalse\subsection{Sweet Cream}\fi % fool texstudio into displaying subsections
\danceinfo{Longway for as many as will}
\danceinstructionsbegin
1 -- 8 	& Dos-à-Dos\\
9 -- 16 & rechte Handmühle\\
\danceinstructionsel
1 -- 8 & FC Balancé (rechte Hand) \& Box the Gnat\\
9 -- 16 & SC Balancé (rechte Hand) \& Box the Gnat\\
\danceinstructionsel
1--8 & Set rechts, \nicefrac{1}{2} Turn Partner (rechte Hand)\\
9--16 & \nicefrac{1}{2} Turn (unter beiden Armen GUZ), \nicefrac{1}{2} Turn (linke Hand)\\
\danceinstructionsel
1--8 & linke Handmühle\\
9--16 & Dos-à-Dos mit neuem Nachbarn
\dancedifficultmarker
\danceinstructionsend
