...
\dancename{Wiener Walzer}
%\subsection{Wiener Walzer}
\iffalse\subsection{Wiener Walzer}\fi % fool texstudio into displaying subsections
\danceinfo{Paartanz}
\textit{Dieser Tanz wird hier nicht erklärt ;-)}
...
\danceinfo{Longway for as many as will,\\¾ Takt, Walzerschritte}
\danceinstructionsbegin
1 -- 12 & Rechthand-Mühle\\
13--24& Linkhand-Mühle zurück\\
\danceinstructionsel
...
\dancemediummarker
\danceinstructionsend
\textit{In den Ballanleitungen steht sind rechts \& links für die letzten beiden Figuren vertauscht. Nicht sicher welche Fassung getanzt wird!}
